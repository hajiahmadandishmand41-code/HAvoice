...
| صفحه‌ی درس | `index.php?p=lesson&slug=…` | محتوای درس + جعبه‌ی تمرین با معیارِ سنجش + پیش‌نیاز و منابع + دکمه‌ی «انجام شد» + درس قبلی/بعدی |
...
آخرین اجرا: **۱۰۲ PASS / ۰ FAIL** (و با `--http` روی محیطِ کامل) روی PHP 8.3.
