...
$sourceUrl  = ha_public_file_url((string) ($article['source_url'] ?? ''));
$refs       = array_values(array_filter(array_map('strval', (array) ($article['refs'] ?? []))));
$coverImage = ha_public_file_url((string) ($article['image'] ?? ''));
$attachFile = ha_public_file_url((string) ($article['file'] ?? ''));
?>
