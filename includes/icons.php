...
function ha_icon_paths(): array
{
    ...
    $icons = [
        ...
        /* وضعیتِ «انجام‌نشده» در فهرستِ درس‌ها (دایره‌ی خالی، هم‌خانواده با check) */
        'circle'    => '<circle cx="12" cy="12" r="8.4"/>',
        /* «از نو» / پاک‌کردنِ پیشرفت */
        'rotate'    => '<path d="M19.6 12a7.6 7.6 0 1 1-2.3-5.4"/><path d="M19.9 4.6v4.2h-4.2"/>',
        /* پرچمِ «قدمِ بعدی» */
        'flag'      => '<path d="M6.6 20.2V4.2"/><path d="M6.6 5.2h11l-2.2 3.6 2.2 3.6h-11"/>',

        /* --- افزوده‌های بعدی: پیش‌تر ha_icon('home') و ha_icon('article')
               در مجموعه نبودند و بی‌صدا به آیکونِ «dot» (یک دایره‌ی خالی)
               برمی‌گشتند؛ یعنی سایدبارِ پنلِ مدیریت آیکونِ اشتباه نشان می‌داد. --- */
        'home'      => '<path d="M4.2 10.6 12 4.2l7.8 6.4"/><path d="M6.2 9.8v9.2h11.6V9.8"/><path d="M10 19v-4.8h4V19"/>',
        'article'   => '<path d="M6 3.8h8.6L19 8.2v12H6Z"/><path d="M14.4 3.8v4.6H19"/><path d="M8.8 12h7.4M8.8 15.2h7.4M8.8 18h4.4"/>',
        'edit'      => '<path d="M4.8 19.2h3L18.6 8.4a2.1 2.1 0 0 0-3-3L4.8 16.2Z"/><path d="m14.4 6.6 3 3"/>',
        'trash'     => '<path d="M4.8 7.2h14.4"/><path d="M9.6 7.2V5.4a1.4 1.4 0 0 1 1.4-1.4h2a1.4 1.4 0 0 1 1.4 1.4v1.8"/><path d="M6.6 7.2 7.4 19a1.6 1.6 0 0 0 1.6 1.4h6a1.6 1.6 0 0 0 1.6-1.4l.8-11.8"/><path d="M10.4 11v5.4M13.6 11v5.4"/>',
        'plus'      => '<path d="M12 5.4v13.2M5.4 12h13.2"/>',
        'download'  => '<path d="M12 4.2v10.4"/><path d="m7.8 10.8 4.2 4.2 4.2-4.2"/><path d="M4.8 19.2h14.4"/>',
        'calendar'  => '<rect x="4" y="5.6" width="16" height="14.4" rx="2.2"/><path d="M4 10h16"/><path d="M8.6 3.6v3.6M15.4 3.6v3.6"/>',
        'send'      => '<path d="M20 4 3.8 10.4l6.4 2.6 2.6 6.4Z"/><path d="m10.2 13 -1.4 4.6"/>',
        'eye'       => '<path d="M2.8 12S6.4 6.2 12 6.2 21.2 12 21.2 12 17.6 17.8 12 17.8 2.8 12 2.8 12Z"/><circle cx="12" cy="12" r="2.8"/>',
        'star'      => '<path d="m12 4.2 2.5 5.1 5.6.8-4 4 .9 5.6L12 17l-5 2.7.9-5.6-4-4 5.6-.8Z"/>',
        'sliders'   => '<path d="M5 7.2h14M5 12h14M5 16.8h14"/><circle cx="9" cy="7.2" r="1.9"/><circle cx="15" cy="12" r="1.9"/><circle cx="8" cy="16.8" r="1.9"/>',

        /* --- شبکه‌های اجتماعی (خطی، هم‌سبکِ بقیه‌ی مجموعه) --- */
        'telegram'   => '<path d="M20.7 4.4 3.9 10.8c-.9.34-.88 1.07.04 1.3l4.1 1.28 1.55 4.6c.28.84 1.05 1.05 1.68.46l2.3-2.14 4.3 3.1c.67.49 1.44.2 1.62-.63l2.5-13.1c.2-1.02-.6-1.58-1.2-1.27Z"/><path d="m8.2 13.5 9-5.5"/>',
