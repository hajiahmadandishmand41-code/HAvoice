...
function routes(): array
{
    ...
    $table = [
        ...
        'install'   => ['file' => 'about.php',     'pretty' => 'install',   'title' => 'نصب سامانه'],
        ...
        'admin_message_status'  => ['file' => 'admin/message_status.php', 'pretty' => 'admin/message-status','title' => 'وضعیت پیام',  'admin' => true],
